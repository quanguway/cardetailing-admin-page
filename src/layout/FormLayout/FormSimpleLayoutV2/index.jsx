...
export default function FormSimpleLayoutV2({fields, mode = 'update' | 'create', handleSubmit=() => {}, label, children}) {
                ...
                {children}
                {
                    fields.map((item, index) => {
                        switch (item.type) {
                            ...
                            case 'tree':
                                return (
                                    <InputTypeTree key={index} useStateValue={item.useState} labels={item.labels}/>
                                )
                            case 'tree-simple':
                                return (
                            ...
                            case 'combo':
                                return (
                                    <Autocomplete
                                        ...
                                        renderInput={(params) => <TextField helperText="Some important text" {...params} label={item.label} />}
                                    />
                                )
                                case 'combo-multiple':
                                return (
                            ...
                            case 'textarea':
                                return (
                                    <TextField
                                        ...
                                        onBlur={(event) =>  handleOnchange(event, item.useState[1])}
                                        maxRows={5}/>
                                ) 
                            case 'radio':
                                return(
